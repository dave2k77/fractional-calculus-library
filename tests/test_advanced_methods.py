...
class TestAdomianDecomposition:
    ...
    def test_adomian_decomposition_basic(self):
        ...
        t, solution = adomian_solver.solve(equation, initial_conditions, t_span, n_steps=100, n_terms=5)
    ...
    def test_adomian_decomposition_parallel(self):
        ...
        t, solution_parallel = adomian_solver.solve(equation, initial_conditions, t_span, 
                                                   n_steps=200, n_terms=10, use_parallel=True)
        t, solution_serial = adomian_solver.solve(equation, initial_conditions, t_span, 
...
class TestOptimizedMethods:
    ...
    def test_optimized_adomian_decomposition(self):
        ...
        t, solution = opt_adomian.solve(equation, initial_conditions, t_span, 
                                       n_steps=100, n_terms=5)
