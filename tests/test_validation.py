...
from src.validation.analytical_solutions import (
    AnalyticalSolutions, PowerFunctionSolutions, ExponentialSolutions, 
    TrigonometricSolutions, get_analytical_solution, validate_against_analytical
)
from src.validation.convergence_tests import (
    ConvergenceTester, ConvergenceAnalyzer, OrderOfAccuracy,
    run_convergence_study, run_method_convergence_test, estimate_convergence_rate
)
from src.validation.benchmarks import (
    BenchmarkSuite, PerformanceBenchmark, AccuracyBenchmark,
    run_benchmarks, compare_methods, generate_benchmark_report
)
...
class TestAnalyticalSolutions:
    ...
    def test_validate_against_analytical(self):
        ...
        results = validate_against_analytical(mock_numerical, mock_analytical, test_params)
...
class TestConvergenceTests:
    ...
    def test_convergence_tester_basic(self):
        ...
        result = tester.test_convergence(mock_numerical, mock_analytical, grid_sizes, test_params)
    ...
    def test_convergence_tester_multiple_norms(self):
        ...
        results = tester.test_multiple_norms(mock_numerical, mock_analytical, grid_sizes, test_params)
    ...
    def test_convergence_analyzer(self):
        ...
        results = analyzer.analyze_method_convergence(mock_numerical, mock_analytical, test_cases, grid_sizes)
    ...
    def test_convenience_functions(self):
        ...
        results = run_convergence_study(mock_numerical, mock_analytical, test_cases, grid_sizes)
        assert 'test_cases' in results
        
        # Test run_method_convergence_test
        test_params = {'order': 0.5}
        results = run_method_convergence_test(mock_numerical, mock_analytical, grid_sizes, test_params)
        assert 'l1' in results
...
class TestBenchmarks:
    ...
    def test_accuracy_benchmark(self):
        ...
        result = benchmark.benchmark_method(mock_numerical, mock_analytical, test_params)
    ...
    def test_benchmark_suite(self):
        ...
        results = suite.run_comprehensive_benchmark(methods, mock_analytical, test_cases, n_runs=2)
