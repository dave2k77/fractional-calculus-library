...
class BinomialCoefficients:
    ...
    def compute(self, n: Union[float, int, np.ndarray, jnp.ndarray], 
                k: Union[float, int, np.ndarray, jnp.ndarray]) -> Union[float, np.ndarray, jnp.ndarray]:
        """
        ...
        """
        if self.use_jax and isinstance(n, (jnp.ndarray, float, int)) and isinstance(k, (jnp.ndarray, float, int)):
    ...
    @staticmethod
    def _binomial_scipy(n: Union[float, np.ndarray], k: Union[float, np.ndarray]) -> Union[float, np.ndarray]:
    ...
    def compute_fractional(self, alpha: Union[float, np.ndarray, jnp.ndarray], 
                          k: Union[int, np.ndarray, jnp.ndarray]) -> Union[float, np.ndarray, jnp.ndarray]:
        """
        ...
        """
        if self.use_jax and isinstance(alpha, (jnp.ndarray, float)) and isinstance(k, (jnp.ndarray, int)):
            return self._binomial_fractional_jax(alpha, k)
        elif self.use_numba and isinstance(alpha, (float, int)) and isinstance(k, (int, float)):
            return self._binomial_fractional_numba_scalar(alpha, k)
        else:
            return self._binomial_fractional_scipy(alpha, k)
    
    @staticmethod
    def _binomial_fractional_scipy(alpha: Union[float, np.ndarray], k: Union[int, np.ndarray]) -> Union[float, np.ndarray]:
...
class GrunwaldLetnikovCoefficients:
    ...
    def compute_weighted_coefficients(self, alpha: float, max_k: int, h: float) -> np.ndarray:
        """
...
def binomial(n: Union[float, np.ndarray, jnp.ndarray], 
...
def binomial_fractional(alpha: Union[float, np.ndarray, jnp.ndarray], 
...
def grunwald_letnikov_coefficients(alpha: float, max_k: int,
                                  use_jax: bool = False, use_numba: bool = True) -> np.ndarray:
    """
...
def grunwald_letnikov_weighted_coefficients(alpha: float, max_k: int, h: float,
                                           use_jax: bool = False, use_numba: bool = True) -> np.ndarray:
    """
...
# Special sequences
def pascal_triangle(n: int, use_jax: bool = False, use_numba: bool = True) -> np.ndarray:
    """
...
def fractional_pascal_triangle(alpha: float, n: int, 
                              use_jax: bool = False, use_numba: bool = True) -> np.ndarray:
    """
