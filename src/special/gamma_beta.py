...
class GammaFunction:
    ...
    def compute(self, z: Union[float, np.ndarray, jnp.ndarray]) -> Union[float, np.ndarray, jnp.ndarray]:
        """
        ...
        if self.use_jax and isinstance(z, (jnp.ndarray, float)):
            ...
            return self._gamma_numba_scalar(z)
        else:
    ...
    def log_gamma(self, z: Union[float, np.ndarray, jnp.ndarray]) -> Union[float, np.ndarray, jnp.ndarray]:
        """
...
class BetaFunction:
    ...
    def compute(self, x: Union[float, np.ndarray, jnp.ndarray], 
                y: Union[float, np.ndarray, jnp.ndarray]) -> Union[float, np.ndarray, jnp.ndarray]:
        """
        ...
        """
        if self.use_jax and isinstance(x, (jnp.ndarray, float)) and isinstance(y, (jnp.ndarray, float)):
            return self._beta_jax(x, y)
        elif self.use_numba and isinstance(x, (float, int)) and isinstance(y, (float, int)):
            return self._beta_numba_scalar(x, y)
        else:
            return self._beta_scipy(x, y)
    
    @staticmethod
    def _beta_scipy(x: Union[float, np.ndarray], y: Union[float, np.ndarray]) -> Union[float, np.ndarray]:
        """SciPy implementation for reference and fallback."""
    ...
    def log_beta(self, x: Union[float, np.ndarray, jnp.ndarray], 
                 y: Union[float, np.ndarray, jnp.ndarray]) -> Union[float, np.ndarray, jnp.ndarray]:
        """
...
def gamma(z: Union[float, np.ndarray, jnp.ndarray], 
...
def beta(x: Union[float, np.ndarray, jnp.ndarray], 
...
def log_gamma(z: Union[float, np.ndarray, jnp.ndarray], 
              use_jax: bool = False) -> Union[float, np.ndarray, jnp.ndarray]:
    """
...
def log_beta(x: Union[float, np.ndarray, jnp.ndarray], 
             y: Union[float, np.ndarray, jnp.ndarray],
             use_jax: bool = False) -> Union[float, np.ndarray, jnp.ndarray]:
    """
