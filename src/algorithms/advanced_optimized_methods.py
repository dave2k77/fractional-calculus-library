...
class OptimizedAdomianDecomposition:
    ...
    def solve(self, f: Callable, t: np.ndarray, initial_condition: float = 0.0, 
              max_terms: int = 10) -> np.ndarray:
    ...
    def _compute_adomian_term(y: np.ndarray, t: np.ndarray, n: int, h: float) -> np.ndarray:
...
def optimized_weyl_derivative(f: Union[Callable, np.ndarray], 
...
def optimized_marchaud_derivative(f: Union[Callable, np.ndarray], 
                                 x: Union[float, np.ndarray], 
                                 alpha: Union[float, FractionalOrder],
                                 h: Optional[float] = None) -> Union[float, np.ndarray]:
...
def optimized_hadamard_derivative(f: Union[Callable, np.ndarray], 
                                 x: Union[float, np.ndarray], 
                                 alpha: Union[float, FractionalOrder],
                                 h: Optional[float] = None) -> Union[float, np.ndarray]:
...
def optimized_reiz_feller_derivative(f: Union[Callable, np.ndarray], 
                                    x: Union[float, np.ndarray], 
                                    alpha: Union[float, FractionalOrder],
                                    h: Optional[float] = None) -> Union[float, np.ndarray]:
...
def optimized_adomian_decomposition(f: Callable, t: np.ndarray, 
                                   alpha: Union[float, FractionalOrder],
