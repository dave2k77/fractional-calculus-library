...
class FractionalDefinition:
    ...
    def __init__(self, definition_type: DefinitionType, alpha: Union[float, FractionalOrder]):
        """
...
def create_definition(definition_type: Union[str, DefinitionType], 
                     alpha: Union[float, FractionalOrder]) -> FractionalDefinition:
    """
...
def validate_fractional_order(alpha: float, min_value: float = 0.0, 
                            max_value: float = 2.0) -> bool:
    """
