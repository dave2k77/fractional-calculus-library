#!/usr/bin/env python3
"""
Comprehensive Library Comparison for Fractional Calculus
...
class ComprehensiveLibraryComparison:
    """Comprehensive comparison of fractional calculus libraries"""
...
class ComprehensiveWaveEquation(ComprehensiveLibraryComparison):
    """Comprehensive Wave Equation Comparison"""
    ...
    def differint_fractional_solver(self, alpha=0.5):
        ...
        try:
            ...
            # Get fractional derivative at initial time
            frac_deriv = df.GL(func, 0, self.L, self.nx, alpha)
    ...
    def hpfracc_fractional_solver(self, alpha=0.5):
        ...
        try:
            ...
            # Use hpfracc for fractional derivative
            # Get fractional derivative at initial time
            frac_deriv = grunwald_letnikov(u[0, :], alpha, self.dx)
    ...
    def benchmark(self):
        ...
        print("="*60)
        print("COMPREHENSIVE WAVE EQUATION BENCHMARK")
        print("="*60)
...
def main():
    ...
    print("COMPREHENSIVE LIBRARY COMPARISON FOR FRACTIONAL CALCULUS")
    print("="*70)
    ...
    os.makedirs('comprehensive_library_results', exist_ok=True)
    
    # Run comprehensive benchmark
    wave_bench = ComprehensiveWaveEquation(nx=100, nt=1000, L=1.0, T=1.0, c=1.0)
    ...
    with open('comprehensive_library_results/comprehensive_library_comparison_results.txt', 'w') as f:
        f.write("Comprehensive Library Comparison Results for hpfracc\n")
    ...
    print("Results saved to comprehensive_library_results/comprehensive_library_comparison_results.txt")
