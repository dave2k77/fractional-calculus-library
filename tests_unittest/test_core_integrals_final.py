"""
Final working tests for hpfracc/core/integrals.py
All API mismatches and validation issues addressed
"""
...
class TestRiemannLiouvilleIntegralWorking(unittest.TestCase):
    ...
    def test_riemann_liouville_integral_coerce_function(self):
        ...
        with self.assertRaises((TypeError, ValueError)):
            integral._coerce_function("not a function", x_arg)
...
class TestUtilityFunctionsWorking(unittest.TestCase):
    ...
    def test_trapezoidal_fractional_integral(self):
        ...
        # Test with array input (correct signature)
    ...
    def test_validate_fractional_integral(self):
        ...
        # Test with correct signature: validate_fractional_integral(x, alpha, method)
        is_valid = self.validate_fractional_integral(1.0, 0.5, "RL")
...
class TestIntegrationWorking(unittest.TestCase):
    ...
    def test_utility_functions_integration(self):
        ...
        is_valid = validate_fractional_integral(1.0, 0.5, "RL")
        self.assertIsInstance(is_valid, bool)
