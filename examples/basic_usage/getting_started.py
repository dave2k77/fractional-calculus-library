...
def basic_fractional_derivatives():
    ...
    for i, alpha in enumerate(alpha_values):
        ...
        riemann = RiemannLiouvilleDerivative(alpha=alpha)
        grunwald = GrunwaldLetnikovDerivative(alpha=alpha)
    ...
    plt.tight_layout()
    plt.savefig('examples/basic_usage/basic_fractional_derivatives.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def fractional_integrals_example():
    ...
    plt.tight_layout()
    plt.savefig('examples/basic_usage/fractional_integrals.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def comparison_with_analytical():
    ...
    plt.tight_layout()
    plt.savefig('examples/basic_usage/analytical_comparison.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def error_analysis():
    ...
    plt.tight_layout()
    plt.savefig('examples/basic_usage/convergence_analysis.png', dpi=300, bbox_inches='tight')
    plt.show()
