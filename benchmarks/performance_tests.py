...
class PerformanceBenchmark:
    ...
    def benchmark_optimization_backends(
        self, grid_sizes: List[int] = None
    ) -> Dict[str, Any]:
        ...
        for N in grid_sizes:
            ...
            try:
                ...
                start_time = time.time()
                result_jax = JAXOptimizer.caputo_derivative_gpu(f, t, alpha, h)
                end_time = time.time()
            ...
            try:
                ...
                parallel_computing = NumbaParallelManager(backend="joblib")
                ...
                print(
                    f"    ✅ Parallel (Joblib): {backend_results['Parallel (Joblib)']['time']:.4f}s"
                )
    ...
    def benchmark_memory_usage(self, grid_sizes: List[int] = None) -> Dict[str, Any]:
        ...
        for N in grid_sizes:
            ...
            methods = {
                "Optimized Caputo": OptimizedCaputo(),
                "Optimized Riemann-Liouville": OptimizedRiemannLiouville(),
                "FFT Spectral": AdvancedFFTMethods(method="spectral"),
            }
            ...
            for method_name, method in methods.items():
                try:
                    ...
                    print(
                        f"  ✅ {method_name}: {method_results[method_name]['memory_used']:.2f} MB"
                    )
    ...
    def generate_performance_report(self) -> str:
        ...
        if "derivative_methods" in self.results:
            ...
            for N, methods in self.results["derivative_methods"].items():
                ...
                for method, data in methods.items():
                    if data["time"] is not None:  # Check for None explicitly
        ...
        print(
            "✅ Performance report generated and saved to 'benchmarks/performance_report.txt'"
        )
        return report_text
    ...
    def plot_performance_results(self):
        ...
        if "derivative_methods" in self.results:
            ...
            for method in methods:
                ...
                for N in grid_sizes:
                    ...
                    times.append(
                        time_val if time_val is not None else np.nan
                    )  # Handle None
            ...
            plt.tight_layout()
            plt.savefig(
                "benchmarks/plots/derivative_methods_performance.png",
                dpi=300,
                bbox_inches="tight",
            )
            plt.show()
        ...
        if "optimization_backends" in self.results:
            ...
            for backend in backends:
                ...
                plt.loglog(
                    grid_sizes, times, "o-", label=backend, linewidth=2, markersize=8
                )
            ...
            plt.tight_layout()
            plt.savefig(
                "benchmarks/plots/optimization_backends_performance.png",
                dpi=300,
                bbox_inches="tight",
            )
            plt.show()
        ...
        if "memory_usage" in self.results:
            ...
            plt.tight_layout()
            plt.savefig(
                "benchmarks/plots/memory_usage_analysis.png",
                dpi=300,
                bbox_inches="tight",
            )
            plt.show()
        ...
        if "accuracy_vs_speed" in self.results:
            ...
            for method in methods:
                ...
                for N in grid_sizes:
                    ...
                    error_val = self.results["accuracy_vs_speed"][N][method][
                        "max_error"
                    ]
                ...
                if times:
                    plt.loglog(
                        times, errors, "o-", label=method, linewidth=2, markersize=8
                    )
            ...
            plt.tight_layout()
            plt.savefig(
                "benchmarks/plots/accuracy_vs_speed.png", dpi=300, bbox_inches="tight"
            )
            plt.show()

        print(
            "✅ Performance plots generated and saved to 'benchmarks/plots/' directory"
        )
